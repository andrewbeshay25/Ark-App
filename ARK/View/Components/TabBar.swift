...
struct TabBar: View {
    ...
    var body: some View {
        VStack {
            ...
            .shadow(color: Color("InverseAccentColor").opacity(0.3), radius: 20, x: 0, y: 20)
            .overlay(
                    ...
                    .background(
                        VStack {
                            RoundedRectangle(cornerRadius: 2)
                                .foregroundColor(Color(hex: "a9c2e5"))
...
//    TabItem(icon: RiveViewModel(fileName: "icons", stateMachineName: "CHAT_Interactivity", artboardName: "CHAT"), tab: .directory),
